...
@Entity
@Table(name = "uk_spt_question")
@org.hibernate.annotations.Proxy(lazy = false)
public class SalesPatterQuestion implements java.io.Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 776463814919694720L;
	/**
	 * 话术 问题表
	 */
